...
function App() {
  ...
  const quarterlyTarget =
    target.april + target.may + target.june;

  const quarterlyAchievement =
    achievement.april + achievement.may + achievement.june;

  const quarterlyBalance =
    quarterlyTarget - quarterlyAchievement;
  ...
  return (
    <div className="container">
      ...
      <h2>Quarterly Performance Tracker</h2>
